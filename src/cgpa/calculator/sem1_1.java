...
public class sem1_1 extends javax.swing.JFrame {
    ...
    void saveInfo() {
        try {
            ...
            String sql = "UPDATE PRITOM.INFO11 SET \"CSE1101\" = '" + jComboBox1.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            //String sql = "UPDATE PRITOM.INFO11 SET \"CSE1101\" = 'A' WHERE USERNAME = '190204018'";
            Statement st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"CSE1102\" = '" + jComboBox2.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"CSE1108\" = '" + jComboBox3.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"PHY1115\" = '" + jComboBox4.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"PHY1116\" = '" + jComboBox5.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"MATH1115\" = '" + jComboBox6.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"HUM1107\" = '" + jComboBox7.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"HUM1108\" = '" + jComboBox8.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"CHEM1115\" = '" + jComboBox9.getSelectedItem().toString() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"CGPA\" = '" + jLabel11.getText() + "' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.INFO11 SET \"INSERTED\" = 'Yes' WHERE USERNAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
            sql = "UPDATE PRITOM.STUDENT SET \"GPA11\" = '"+jLabel11.getText()+"' WHERE USER_NAME = '" + username + "'";
            st = con.createStatement();
            st.executeUpdate(sql);
    ...
    void calculate() {
        ...
        double cgpa = (1.5 * (b + c + h) + 3 * (a + d + f + g + i) + 0.75 * e) / 20.25;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CSE-1101");

        jLabel2.setText("CSE-1102");

        jLabel4.setText("PHY-1115");

        jLabel3.setText("CSE-1108");

        jLabel7.setText("HUM-1107");

        jLabel5.setText("PHY-1116");

        jLabel9.setText("CHEM-1115");

        jLabel6.setText("MATH-1115");
